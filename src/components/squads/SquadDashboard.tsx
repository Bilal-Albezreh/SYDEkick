...
export default function SquadDashboard({ squad }: SquadDashboardProps) {
    const router = useRouter();
    const [copied, setCopied] = useState(false);
    const [chatMessage, setChatMessage] = useState("");
    const [isLeaving, setIsLeaving] = useState(false);

    const isLeader = squad.my_role === 'leader';

    // Mock members for now (will be fetched from squad_memberships)
    const mockMembers: SquadMember[] = [
        { id: '1', name: 'You', email: 'you@example.com', role: squad.my_role, joined_at: new Date().toISOString() },
    ...
    const members = squad.members || mockMembers;
    ...
    const handleLeaveSquad = async () => {
        ...
        setIsLeaving(true);
        const result = await leaveSquad(squad.id);
        setIsLeaving(false);
    ...
    return (
        <div className="min-h-screen p-6">
            {/* Background Gradient */}
            <div className="fixed inset-0 bg-gradient-to-br from-indigo-950/30 via-black to-purple-950/30 -z-10" />
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {squad.description && (
                            <div className="bg-black/20 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-6">
                                ...
                                <p className="text-white/70">{squad.description}</p>
                            </div>
                        )}
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-black/20 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl h-[600px] flex flex-col">
                            {/* Chat Header */}
