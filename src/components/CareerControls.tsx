...
export default function CareerControls() {
  ...
  return (
    <div className="h-full bg-[#0a0a0a] border border-gray-800 rounded-2xl p-5 flex flex-col gap-6 shadow-xl">
      <div>
              ...
              <form onSubmit={handleBulkAdd} className="space-y-3">
                 <div className="relative">
                    <Input 
                        ...
                        className="bg-black/40 border-gray-700 text-lg font-mono placeholder:text-gray-700 pr-12"
                        min="1"
                    />
              ...
              <form onSubmit={handleBulkMove} className="space-y-3">
                 <div className="flex flex-col gap-2">
                       <Input 
                            ...
                            className="bg-black/40 border-gray-700 text-center font-mono h-9" min="1"
                        />
                       <Select value={moveTarget} onValueChange={setMoveTarget}>
                          <SelectTrigger className="bg-black/40 border-gray-700 h-9 text-xs"><SelectValue /></SelectTrigger>
                          <SelectContent>
